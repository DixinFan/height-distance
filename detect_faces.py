...
def get_face_detector(modelFile="../height-extraction/models/res10_300x300_ssd_iter_140000.caffemodel",
                      configFile="../height-extraction/models/deploy.prototxt"):
    """
    ...
    modelFile : string, optional
        Path to model file. The default is "../height-extraction/models/res10_300x300_ssd_iter_140000.caffemodel".
    configFile : string, optional
        Path to config file. The default is "../height-extraction/models/deploy.prototxt".
    ...
    """
    modelFile = "../height-extraction/models/res10_300x300_ssd_iter_140000.caffemodel"
    configFile = "../height-extraction/models/deploy.prototxt"
...
def get_landmark_model(saved_model='../height-extraction/models/pose_model'):
    """
    ...
    saved_model : string, optional
        Path to facial landmarks model. The default is '../height-extraction/models/pose_model'.
